  ...
  const agents: Agent[] = [
    {
      ...
      icon: MessageSquare,
      color: "bg-green-500",
      description: "Support technique TeamSquare 24/9",
    },
  ]
    ...
    try {
      ...
      if (response.ok) {
        ...
        return {
          ...
          metadata: {
            source: data.source || "teamsquare_agent",
            agent: selectedAgent,
      ...
      // Fallback vers l'API chat si agentic échoue
      ...
      if (fallbackResponse.ok) {
        ...
        return {
          content: fallbackData.content || fallbackData.response,
          metadata: {
            source: "chat_api",
            agent: selectedAgent,
          },
      ...
      const fallbackResponses = [
        ...
        "Notre équipe support TeamSquare est à votre disposition. Que puis-je faire pour vous ?",
        "Je rencontre une difficulté temporaire. Veuillez réessayer dans quelques instants.",
        "Votre demande est importante. Pouvez-vous me donner plus de détails ?",
      ]
